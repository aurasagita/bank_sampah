    ...
    <div class="card">
        <div class="card-header border-0">
          <div class="d-flex justify-content-between">
           <h3 class="card-title"><b>Jadwal Nasabah</b></h3>
          </div>
          <div class="card-body">
            <div class="row d-flex justify-between" style="width: 100%; justify-content: space-between; align-items: center; margin: 0">
              <a href="{{url('nasabah_jadwal/create')}}" class="btn -btn sm btn-success my-2">Tambah Data</a>
                        ...
                        @foreach($nasabah as $i => $m)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('/nasabah_jadwal/'. $m->id)}}"class="btn btn-sm btn-primary"><i class="fas fa fa-info-circle"></i></a>
                                  </td>

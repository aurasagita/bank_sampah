...
<div class="card">
  <div class="card-body">
    <div class="input-group mb-3 mt-2">
     <label class="mb-3">Tanggal Awal <input type="date" name="tanggal_awal" id="tanggal_awal" class="form-control"></label></div>
    <div class="input-group mb-3">
     <label for="label">Tanggal Akhir<input type="date" name="tanggal_akhir" id="tanggal_akhir" class="form-control"></label></div>
   </div>
 </div>
 <div class="input-group mb-3">
